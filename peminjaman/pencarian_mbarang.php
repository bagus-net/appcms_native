...
$pageSql 	= "SELECT * FROM mbarang WHERE kode='BJ' $cariSQL";
...
<h1><b>PENCARIAN Master Barang </b></h1>
...
<table class="table-list" width="1200" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="139" bgcolor="#CCCCCC"><strong>Kode</strong></td>
    <td width="363" bgcolor="#CCCCCC"><strong>Nama Item </strong></td>
    <td width="139" bgcolor="#CCCCCC"><strong>Ukuran</strong></td>
    <td width="295" bgcolor="#CCCCCC"><strong>Substance</strong></td>
    <td width="87" bgcolor="#CCCCCC"><strong>Flute  </strong></td>
    <td width="87" bgcolor="#CCCCCC"><strong>Type  </strong></td>
    <td width="86" bgcolor="#CCCCCC"><strong>Sambungan</strong></td>
    </tr>
  <?php
...
//	$pageQry 	= pg_query($koneksidb, $pageSql)  or die ("Query  salah : ".pg_last_error());
	...
	$mySql = "SELECT * FROM mbarang where jenis='BJ' $cariSQL ORDER BY kode ASC ";  // LIMIT $halaman, $baris";
...
//	while ($myData = mysql_fetch_array($myQry)) {
  ...
  <tr>
    ...
    <td><a href="#" onClick="window.opener.document.getElementById('txtKodeBuku').value = '<?php echo $myData['kode']; ?>';
  ...
  <tr class="selKecil">
	...
	for ($h = 1; $h <= $maksData; $h++) {
		...
		echo " <a href='pencarian_mbarang.php?hal=$list[$h]'>$h</a> ";
	}
	?></td>
  </tr>
</table>
